...
func Load() (Config, error) {
	...
	if firstPartyAuthEnabled { cookieSecureDefault = "true" }
	...
	if v := os.Getenv("APP_MASTER_KEY_B64"); v != "" {
		...
		if err != nil || len(raw) != 32 { return Config{}, errors.New("APP_MASTER_KEY_B64 must be base64 for exactly 32 bytes") }
		cfg.MasterKey = raw
	}
